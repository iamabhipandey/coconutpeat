  ...
  public header: header[] = [
    {
      ...
      menu: [
        {
          menuValue: 'HEADER.CEO_GREETING',
          hasSubRoute: false,
          routes: routes.CeoGreeting,
          showSubRoute: false,
          subMenus: [],
        },
        { menuValue: 'HEADER.VISION', hasSubRoute: false, routes: routes.Vision2030Module, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.HISTORY', hasSubRoute: false, routes: routes.CompanyHistory, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.SOCIAL_CONTRIBUTION', hasSubRoute: false, routes: routes.SocialContribution, showSubRoute: false, subMenus: [], },
      ],
    },
    {
      ...
      separateRoute: false,
      menu: [
        { menuValue: 'HEADER.COCOPEAT', hasSubRoute: false, routes: routes.cocopeat, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.USAGE_FARMS', hasSubRoute: false, routes: routes.usageFarms, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.PERFORMANCE', hasSubRoute: false, routes: routes.performance, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.FACTORY_LOCALLY', hasSubRoute: false, routes: routes.factory, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.QUALITY_CONTROL', hasSubRoute: false, routes: routes.qualityControl, showSubRoute: false, subMenus: [], },
      ],
    },
    {
      tittle: 'HEADER.RND',
      ...
      separateRoute: false,
      menu: [
        { menuValue: 'HEADER.AGRI_RESEARCH', hasSubRoute: false, routes: routes.agriculturalResearchInstitute, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.CERTIFICATIONS', hasSubRoute: false, routes: routes.certificationDetails, showSubRoute: false, subMenus: [], },
    ...
    },
    {
      ...
      separateRoute: false,
      menu: [
        { menuValue: 'HEADER.KAKAO', hasSubRoute: false, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.WHATSAPP', hasSubRoute: false, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.OEM_ODM', hasSubRoute: false, routes: routes.oemOdmInquiries, showSubRoute: false, subMenus: [], },
      ],
    ...
    },
    {
      ...
      separateRoute: false,
      menu: [
        { menuValue: 'HEADER.LOCHE_NEWS', hasSubRoute: false, routes: routes.LocheNews, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.LOCHE_COMMERCIAL', hasSubRoute: false, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.PARTNER_COMPANIES', hasSubRoute: false, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.INTRODUCTION_CI', hasSubRoute: false, showSubRoute: false, subMenus: [], },
      ],
    ...
    },
    {
      ...
      separateRoute: false,
      menu: [
        { menuValue: 'HEADER.PRESS_RELEASE', hasSubRoute: false, routes: routes.LocheNews, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.PROMOTIONAL_VIDEO', hasSubRoute: false, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.ADVERTISING', hasSubRoute: false, showSubRoute: false, subMenus: [], },
      ],
    ...
    },
    {
      ...
      separateRoute: false,
      menu: [
        { menuValue: 'HEADER.COCOI', hasSubRoute: false, showSubRoute: false, subMenus: [], },
        { menuValue: 'HEADER.HYOBATO', hasSubRoute: false, showSubRoute: false, subMenus: [], },
      ],
